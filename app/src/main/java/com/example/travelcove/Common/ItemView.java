...
public class ItemView extends AppCompatActivity {
    ...
    ImageView imageView;
    TextView textView, textDesc, textDesc2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDesc2 = findViewById(R.id.textViewDesc2);
        ...
        if(intent.getExtras() != null) {
            ...
            textDesc2.setText(itemsModel.getDesc2());

            placeName = itemsModel.getName();
        ...
        documentReference.get()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ItemView.this, "Error ! " + e.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
