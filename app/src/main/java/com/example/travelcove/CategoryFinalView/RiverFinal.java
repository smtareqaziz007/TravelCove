...
import com.example.travelcove.HelperClasses.HomeAdapter.RiverHelperClass;
...
public class RiverFinal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_river_final);
        ...
        if(intent.getExtras() != null) {
            rh = (RiverHelperClass) intent.getSerializableExtra("sea");

            imageView.setImageResource(rh.getImage());
            textView.setText(rh.getTitle());
            placeName = rh.getTitle();
        ...
        documentReference.get()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(RiverFinal.this, "Error ! " + e.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
