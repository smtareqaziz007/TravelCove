...
import com.example.travelcove.HelperClasses.HomeAdapter.HeritageHelperClass;
...
public class HeritageFinal extends AppCompatActivity {
    ...
    HeritageHelperClass heritageHelperClass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heritage_final);
        ...
        if(intent.getExtras() != null) {
            heritageHelperClass = (HeritageHelperClass) intent.getSerializableExtra("heritage");

            imageView.setImageResource(heritageHelperClass.getImage());
            textView.setText(heritageHelperClass.getTitle());
            placeName = heritageHelperClass.getTitle();
        ...
        documentReference.get()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(HeritageFinal.this, "Error ! " + e.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
